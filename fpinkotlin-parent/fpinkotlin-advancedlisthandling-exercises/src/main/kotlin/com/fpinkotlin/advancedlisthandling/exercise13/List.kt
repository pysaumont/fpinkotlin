...
sealed class List<out A> {
    ...
    fun getAt(index: Int): Result<A> = TODO("Implement this function")
    ...
    internal object Nil: List<Nothing>() {
        ...
        override fun <B> foldLeft(identity: B, zero: B, f: (B) -> (Nothing) -> B): B = TODO("Implement this function")
    ...
    internal class Cons<out A>(internal val head: A,
        ...
        override fun <B> foldLeft(identity: B, zero: B, f: (B) -> (A) -> B): B = TODO("Implement this function")
